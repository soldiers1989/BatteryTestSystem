...
namespace BatteryTestSystem_Comm
{
    ...
    public class SerialPortUtil
    {
        ...
        private SerialPortBaudRates _baudRate = SerialPortBaudRates.BaudRate_4800;//波特率
        private Parity _parity = Parity.Mark;//校验位
        ...
        {
            _portName = "COM1";
            _baudRate = SerialPortBaudRates.BaudRate_4800;
            _parity = Parity.Mark;
        ...
        void comPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            byte[] receviedBuf;
            receviedBuf = new byte[comPort.BytesToRead];//comPort.BytesToRead

            int itemp = comPort.BytesToRead;//comPort.BytesToRead;
            int rcvByteLen = 0;
            try
            {
